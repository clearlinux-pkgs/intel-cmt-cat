...
Version  : v23.11.1
Release  : 23
URL      : https://github.com/intel/intel-cmt-cat/archive/v23.11.1/intel-cmt-cat-v23.11.1.tar.gz
Source0  : https://github.com/intel/intel-cmt-cat/archive/v23.11.1/intel-cmt-cat-v23.11.1.tar.gz
...
%prep
%setup -q -n intel-cmt-cat-23.11.1
cd %{_builddir}/intel-cmt-cat-23.11.1
%patch -P 1 -p1
pushd ..
cp -a intel-cmt-cat-23.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709288748
...
cp %{_builddir}/intel-cmt-cat-23.11.1/LICENSE %{buildroot}/usr/share/package-licenses/intel-cmt-cat/a4a43e608149714ad15f92d9f363b39bf0ea8894 || :
cp %{_builddir}/intel-cmt-cat-23.11.1/appqos/LICENSE %{buildroot}/usr/share/package-licenses/intel-cmt-cat/ae790ed217e8133bdd20c1d2c3401a4b3a587220 || :
cp %{_builddir}/intel-cmt-cat-23.11.1/lib/python/LICENSE %{buildroot}/usr/share/package-licenses/intel-cmt-cat/ae790ed217e8133bdd20c1d2c3401a4b3a587220 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
