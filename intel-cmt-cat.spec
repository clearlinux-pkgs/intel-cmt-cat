...
Version  : 25.04
Release  : 25
URL      : https://github.com/intel/intel-cmt-cat/archive/v25.04/intel-cmt-cat-25.04.tar.gz
Source0  : https://github.com/intel/intel-cmt-cat/archive/v25.04/intel-cmt-cat-25.04.tar.gz
...
%prep
%setup -q -n intel-cmt-cat-25.04
cd %{_builddir}/intel-cmt-cat-25.04
%patch -P 1 -p1
pushd ..
cp -a intel-cmt-cat-25.04 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745598716
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libpqos.so.6
/usr/lib64/libpqos.so.6.0.1
