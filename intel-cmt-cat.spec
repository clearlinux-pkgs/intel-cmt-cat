...
Version  : 24.05
Release  : 24
URL      : https://github.com/intel/intel-cmt-cat/archive/v24.05/intel-cmt-cat-24.05.tar.gz
Source0  : https://github.com/intel/intel-cmt-cat/archive/v24.05/intel-cmt-cat-24.05.tar.gz
...
%prep
%setup -q -n intel-cmt-cat-24.05
cd %{_builddir}/intel-cmt-cat-24.05
%patch -P 1 -p1
pushd ..
cp -a intel-cmt-cat-24.05 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720040765
